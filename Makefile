...
BOOTLOADER_ENTRYPOINT = 0x50210000
...
SRC_TEST2	= ./test/test_project3/test_wait.c ./test/test_project3/test_semaphore.c ./test/test_project3/test_multicore.c ./test/test_project3/test_kill.c ./test/test_project3/test_affinity.c ./test/test_project3/test_barrier.c ./test/test_project3/test_mailbox.c ./test/test_project3/test_multi_mbox.c

SRC_MAIN	= ${SRC_ARCH} ${SRC_INIT} ${SRC_INT} ${SRC_DRIVER} ${SRC_LOCK} ${SRC_SCHED} ${SRC_MM} ${SRC_SYSCALL} ${SRC_LIBS} ${SRC_LIBC} ${SRC_TEST} ${SRC_TEST2}
