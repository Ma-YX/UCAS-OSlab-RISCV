...
/*[TASK5] */
struct task_info task2_13 = {(ptr_t)&prior_task1, USER_THREAD};
struct task_info task2_14 = {(ptr_t)&prior_task2, USER_THREAD};
struct task_info task2_15 = {(ptr_t)&fork_task, USER_THREAD};
struct task_info *fkpr_tasks[16] = {&task2_13, &task2_14, &task2_15};
int num_fkpr_tasks = 3;