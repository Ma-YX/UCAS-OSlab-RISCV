...
void sys_cd(char *name){
    invoke_syscall(SYSCALL_CD, name, IGNORE, IGNORE, IGNORE);
}
...
void sys_fs_ls(char *name){
    invoke_syscall(SYSCALL_FS_LS, name, IGNORE, IGNORE, IGNORE);
}
...
int sys_fopen(char *name,int access){
    return invoke_syscall(SYSCALL_OPEN_FILE, name, access, IGNORE, IGNORE);
}

int sys_close(int fd){
    return invoke_syscall(SYSCALL_CLOSE_FILE, fd, IGNORE, IGNORE, IGNORE);
}
...
int sys_rmfile(char *name){
    return invoke_syscall(SYSCALL_RMFILE, name, IGNORE, IGNORE, IGNORE);
}

int sys_ln(char*src, char*dst){
    return invoke_syscall(SYSCALL_LINK, src, dst, IGNORE, IGNORE);
}

int sys_ls_l(char *name){
    return invoke_syscall(SYSCALL_LS_L, name, IGNORE, IGNORE, IGNORE);
}
